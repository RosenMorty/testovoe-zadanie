...
const userBase = [
    ...
    {
        id: 3,
        image: 'https://i.pinimg.com/originals/86/95/54/8695540db1e9224367ed9d1a4884ccfc.jpg',
        title: 'Gon Friks',
        email: 'gonfriks@gmail.com',
        phone: '010-000-1000 x01011',
        about: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.'
    },
    {
        id: 4,
        image: 'https://steamuserimages-a.akamaihd.net/ugc/1027328734216725904/A78445AD26E88C8331629E52FC752B5B09253E71/?imw=5000&imh=5000&ima=fit&impolicy=Letterbox&imcolor=%23000000&letterbox=false',
        title: 'Killua Zoldik',
        email: 'illumiff@gmail.com',
        phone: '022-666-6656 x69626',
        about: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.'
    },
]
...
() => {
    ...
    const showedUsers = computed(() => {
        return userBase.filter((user) => {
            return `${user.title} + ${user.email}`.toUpperCase().includes(inputValue.value.toUpperCase())
        })
    })
    ...
    const selectedUser = computed(() => {
        return userBase.find((user) => {
            return user.id === activeId.value
        })
    })
