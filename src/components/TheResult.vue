<template>
    <div class="resultbar-search">
        <div v-if="!viewResult" class="resultbar-text">Выберите сотрудника, чтобы посмотреть его профиль</div>
        <div class="resultbar-image" v-else>
            <div>
                <img class="resultbar-image__cart" :src="viewResult.image">
            </div>
            <div class="resultbar-info"> 
                <div class="resultbar-title">{{ viewResult.title }}</div>
                <div class="resultbar-email">email: <span class="resultbar-email__text">{{ viewResult.email }}</span></div>
                <div class="resultbar-phone">phone: <span class="resultbar-phone__text">{{ viewResult.phone }}</span></div>
                <div class="resultbar-about">О себе:</div>
                <div class="resultbar-about__text">{{ viewResult.about }}</div>
            </div> 
        </div>
    </div>
</template>
